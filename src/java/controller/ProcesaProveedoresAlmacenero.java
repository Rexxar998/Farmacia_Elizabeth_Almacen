 ...
 * @author casa
 */
@WebServlet(name = "ProcesaProveedoresAlmacenero", urlPatterns = {"/ProcesaProveedoresAlmacenero","/Usuario%20Almacenero/ProcesaProveedoresAlmacenero"})
public class ProcesaProveedoresAlmacenero extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (opcion != null && opcion.equals("insertar")) {
            ...
            request.getRequestDispatcher("Proovedores_Almacenero.jsp").forward(request, response);
