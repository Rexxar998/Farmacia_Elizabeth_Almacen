 ...
 * @author casa
 */
@WebServlet(name = "ProcesaTipoMovimientoAlmacenero", urlPatterns = {"/ProcesaTipoMovimientoAlmacenero","/Usuario%20Almacenero/ProcesaTipoMovimientoAlmacenero"})
public class ProcesaTipoMovimientoAlmacenero extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (opcion != null && opcion.equals("insertar")) {
            ...
            request.getRequestDispatcher("TipoMovimiento_Almacenero.jsp").forward(request, response);
