...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="CSS/inven_class.css">
                ...
                <div class="col-xs-12 col-md-9">
                    ...
                    <div class="col inventario">
                        <div class="row">
                            ...
                            <a class="col-md-1 btn btn-primary yojhan" role="button" href="RegistrarInv.jsp">Agregar</a>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="barra-lateral">
                            <table class="table table-bordered table-hover" style="border: black;" border="1px" cellspacing="0" cellpadding="8">
                                ...
                                <tr class="trcolr" align="center">
                                    ...
                                    <td>
                                        <a href="DetalleInv.jsp"><button class="botonDetails"><i class="fa-solid fa-info"></i></button></a>
