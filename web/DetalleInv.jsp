            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-9">
                    <div class="col inventario">
                        <div>
                            <div class="row">
                                <h4 class="col-md-3"><b>Detalle Inventario</b></h4>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input class="form-control" type="text" placeholder="Número Inventario" name="codInventario" style="background-color: #EAECE9;" value="T001" readonly>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input class="form-control" type="date" name="FechaInv" style="background-color: #EAECE9;" value="17/06/03" readonly>
                                </div>
                                <div class="col-md-8"></div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input class="form-control" type="time" name="HoraInv" style="background-color: #EAECE9;" value="12:30" readonly>
                                </div>
                                <div class="col-md-8"></div>
                            </div>
                            <br>
                            ...
                            <div class="barra-lateral">
                                <table class="table table-bordered" style="border: black;" border="1px" cellspacing="0" cellpadding="8">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text" placeholder="Observaciones" name="Obsv" style="background-color: #EAECE9;" readonly>
                                </div>
                            </div>
                            <div class="row mt-3">    
