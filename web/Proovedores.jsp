            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-9">
                    ...
                    <div class="col inventario">
                        ...
                        <form action="ProcesaProveedores" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control" style="height: 36px;" type="text" placeholder="Número de Ruc" name="ruc" required>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-2">
                                    <label for="RazonSocial"><h4 class="htext">Razón Social: </h4></label>
                                    <input class="form-control" style="height: 36px;" type="text" placeholder="Razón Social" name="razonSocial" required>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-3">
                                    <label for="direcProv"><h4 class="htext">Dirección: </h4></label>
                                    <input class="form-control" style="height: 36px;" type="text" placeholder="Dirección Laboratorio" name="direccion" required>
                                </div>
                                <div class="col-3"></div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-md-3 mt-2">
                                    ...
                                    <input class="form-control" style="height: 36px;" type="text" placeholder="Correo Laboratorio" name="correo" required="">
                                </div>
                                <div class="col-md-1"></div>
                        ...
                        <hr>
                        <h4 class="bajabusc"><b>Buscar Laboratorio</b></h4>
                        <form action="Proovedores.jsp" method="post">
