...
<html lang="us">
    ...
    <head>
        ...
        <link rel="stylesheet" href="CSS/inicio_Almacenero.css">
        <!-- Incluir archivo JavaScript externo para la funcionalidad interactiva -->
        <script src="JS/rees_Almacenero.js"></script>
        <!-- BOOSTRAP -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col columna text-center">
                    ...
                    <a href="../index.jsp"><h4 class="titulo"style="margin-left: 15px"> Selecciona tu usuario</h4></a>
                </div>

                <div class="col">
                    <div class="row justify-content-center">
                        <div class="col text-center">
                            <h2>Bienvenido Almacenero</h2>
                        </div>
                    </div>                
                    <div class="row justify-content-center">
                        <div class="col-8">
                            <form action="AutenticaAlmacenero" method="post">
                                <input type="hidden" name="alm" value="almacenero" required>
                                <div class="col">
                                ...
                                <div class="row">
                                    <div class="col-2"></div>    
                                    <div class="g-recaptcha col-8" data-sitekey="6LeGJOkpAAAAAExd-sTFLzKsby29VHC4Szffyqct"></div>
                                    <div class="col-2"></div>       
                                </div> 
                                <div class="row">
                                    <div class="col-3"></div>
                                    <div class="col-9">
                                        <input class="input-boton" type="submit" value="Ingresar"></div>
                                </div>  
                        </div>
                    </div>
                    </form>
                    ...
                    <div class="row">
                        <div class="col-4"></div>
                        <div class="col-8"><a href="#" onclick="abrirPopup()" class="movcontra">¿Olvidaste tu contraseña?</a></div>
                    </div>
