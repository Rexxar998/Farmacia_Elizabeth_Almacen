            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-9">
                    ...
                    <div class="row">
                        <div class="row">
                            <div class="col">
                                <h3><b>Bienvenida Elizabeth - Farmacia</b></h3>
                        ...
                        <center>
                            <div class="row">                               
                                <div class="col comienza text-center">
                                    <h4 class="movcont movcom"><b>Comienza</b></h4>
                                    <button class="boton3">Personaliza tu Sitio</button>
                                </div>
                                ...
                                <div class="col acciones">
                                    ...
                                    <i class="movcont bi bi-receipt-cutoff"><a href="Inventario.jsp">Gestiona tu inventario</a></i>
                                    <br>
