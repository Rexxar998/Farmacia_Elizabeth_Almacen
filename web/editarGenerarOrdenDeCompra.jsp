                ...
                <div class="col-xs-12 col-md-9">
                    <div class="col inventario">
                        ...
                        <div class="barra-lateral">
                            <table class="table table-bordered table-hover" style="border: black;"
                                ...
                                <tr class="trcolr" align="center">
                                    <td>
                                        <select class="form-select" aria-label="Default select example" form="formularioEditar<%= i %>" name="nombreProd" required>
                                            <option value="<%= listaDetalles.get(i).getNombre_prod()%>" selected readonly><%= listaDetalles.get(i).getNombre_prod()%></option>                                           
                                        </select>
                                    </td>
                                    <td>
                                        <select class="form-select" aria-label="Default select example" form="formularioEditar<%= i %>" name="tipoProd" required>
                                            <option value="<%= listaDetalles.get(i).getTipo_prod()%>" selected readonly><%= listaDetalles.get(i).getTipo_prod()%></option>
                                        </select>
                                    </td>
                                    <td>
                                        <!-- Cambiado a un input para la cantidad -->
                                        <input type="text" form="formularioEditar<%= i %>" name="cantidad" value="<%= listaDetalles.get(i).getCantidad()%>" />
                                    </td>
                                    <td>
                                        <!-- Cambiado a un input para el precio de compra -->
                                        <input type="text" form="formularioEditar<%= i %>" name="precioCompra" value="<%= listaDetalles.get(i).getPrecioCompra()%>" />
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="eliminarGenerarOrdenDeCompra.jsp?secuencia_detalle_orden=<%= listaDetalles.get(i).getSecuencia_detalle_orden()%>">
                                            <button class="botonEliminarProduct"><i class="fa-solid fa-trash-can"></i></button>
                                        </a>
                                    </td>
                                </tr>
                                <%
                        ...
                        <div class="row">
                            ...
                            <a href="GenerarOrdenCompra.jsp" rule="button" class="btn btn-primary buttonOrden col-md-1 mt-2">Aceptar<!--<i class="fa-solid fa-plus"></i>--></a>
                            <div class="col-md-4"></div>
                        </div>
                        </tr>
                    </div>
