                        ...
                        <form action="ProcesaProveedores" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input class="form-control" style="height: 36px;" class="razondirecProv" type="text" placeholder="Razón Social" name="razonSocial" value="<%= proveedor.getRazonSocial()%>" readonly>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-3">
                                    <label for="direcProv"><h4 class="htext">Dirección: </h4></label>
                                    <input class="form-control" style="height: 36px;" class="razondirecProv" type="text" placeholder="Dirección Laboratorio" name="direccion" value="<%= proveedor.getDireccion()%>" readonly>
                                </div>
                                <div class="col-3"></div>
                            </div>
                            <br>
                            <div class="row">
                                <div class="col-md-2 mt-2">
                                    ...
                                    <input class="form-control" style="height: 36px;" type="text" placeholder="Número teléfono" name="telefono" value="<%= proveedor.getTelefono()%>" readonly>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-3 mt-2">
                                    <label for="correoProv"><h4 class="htext">Correo: </h4></label>
                                    <input class="form-control" style="height: 36px;" class="correoProv" type="text" placeholder="Correo Laboratorio" name="correo" value="<%= proveedor.getCorreo()%>" readonly>
                                </div>
                                <div class="col-md-1"></div>
                                <div class="col-md-2 mt-5">
                                    <button type="button" class="btn btn-primary btnProvee" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Aceptar</button>
                                    <!-- Modal -->
                        ...
                        <div class="tablaProvee">
                            <table class="alinearrder table table-bordered table-hover tablaProvee" style="border: black;">
                                ...
                                <tr class="trcolr" align="center">
                                    ...
                                    <td>
                                        <a href="editarProveedores.jsp?idLaboratorio=<%= listaProveedores.get(i).getIdLaboratorio()%>"><button class="botonActualizarProvee"><i class="fa-solid fa-pen-to-square "></i></button></a>
                                        <a href="eliminarProveedores.jsp?idLaboratorio=<%= listaProveedores.get(i).getIdLaboratorio()%>"><button class="botonEliminarProvee"><i class="fa-solid fa-trash-can"></i></button></a>                                                                                            
                                    </td>
                                </tr>
                                <%
                                        }
